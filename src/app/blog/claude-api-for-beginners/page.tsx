...
print(f"Done. {len(results)} files summarized → summaries.csv")`}</pre>
          ...
          <p>The API approach gives you more control and lower cost per call; Make gives you faster setup and easy integration with the tools you already use. Pick based on your comfort with code and how much customization you need.</p>
