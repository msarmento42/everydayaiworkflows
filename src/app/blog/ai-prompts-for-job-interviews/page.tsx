...
export const metadata = {
  ...
  description: "Copy-paste-ready AI prompts covering every stage of interview prep â research, behavioral stories, mock interviews, salary negotiation, and follow-up.",
};
    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0f0f23 0%, #1a1a3e 50%, #0d1b2a 100%)", color: "#fff", fontFamily: "system-ui, sans-serif", padding: "2rem" }}>
      <div style={{ maxWidth: "800px", margin: "0 auto", paddingTop: "2rem" }}>
        ...
        <div style={{ marginTop: "1rem", display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
          ...
          <span style={{ fontSize: "0.75rem", color: "#6b7280" }}>â±ï¸ 9 min read</span>
        ...
        <div style={{ lineHeight: "1.8", fontSize: "1.05rem", color: "#d1d5db" }}>
          ...
          <h2 style={{ fontSize: "1.5rem", color: "#fff", marginTop: "2rem", marginBottom: "1rem", borderBottom: "1px solid #374151", paddingBottom: "0.5rem" }}>Phase 1: Company and Role Research (Prompts 1â3)</h2>
          ...
          <pre style={{ background: "rgba(0,0,0,0.4)", border: "1px solid #374151", borderRadius: "8px", padding: "1.25rem", overflowX: "auto", fontSize: "0.9rem", color: "#a5f3fc", marginBottom: "1rem" }}>{`PROMPT 1 â Company Intelligence Brief
...
- 3 smart questions I should ask to show I have done my research`}</pre>
          <pre style={{ background: "rgba(0,0,0,0.4)", border: "1px solid #374151", borderRadius: "8px", padding: "1.25rem", overflowX: "auto", fontSize: "0.9rem", color: "#a5f3fc", marginBottom: "1rem" }}>{`PROMPT 2 â Job Description Decoder
...
4. Keywords I should weave into my answers`}</pre>
          <pre style={{ background: "rgba(0,0,0,0.4)", border: "1px solid #374151", borderRadius: "8px", padding: "1.25rem", overflowX: "auto", fontSize: "0.9rem", color: "#a5f3fc", marginBottom: "1rem" }}>{`PROMPT 3 â Competitive Landscape Scan
...
without sounding like I memorized a Wikipedia article.`}</pre>
          <h2 style={{ fontSize: "1.5rem", color: "#fff", marginTop: "2rem", marginBottom: "1rem", borderBottom: "1px solid #374151", paddingBottom: "0.5rem" }}>Phase 2: Behavioral Story Prep (Prompts 4â7)</h2>
          <p>Behavioral questions â "tell me about a time when..." â trip up most candidates because they improvise vague answers. The STAR format (Situation, Task, Action, Result) fixes this, but building strong STAR stories takes time. These prompts compress that work from hours to minutes.</p>
          <pre style={{ background: "rgba(0,0,0,0.4)", border: "1px solid #374151", borderRadius: "8px", padding: "1.25rem", overflowX: "auto", fontSize: "0.9rem", color: "#a5f3fc", marginBottom: "1rem" }}>{`PROMPT 4 â STAR Story Builder
...
Make it compelling but honest â no fabrication.`}</pre>
          <pre style={{ background: "rgba(0,0,0,0.4)", border: "1px solid #374151", borderRadius: "8px", padding: "1.25rem", overflowX: "auto", fontSize: "0.9rem", color: "#a5f3fc", marginBottom: "1rem" }}>{`PROMPT 5 â Story Bank Generator
...
Cover: leadership, conflict, failure, innovation, and cross-team collaboration.`}</pre>
          <pre style={{ background: "rgba(0,0,0,0.4)", border: "1px solid #374151", borderRadius: "8px", padding: "1.25rem", overflowX: "auto", fontSize: "0.9rem", color: "#a5f3fc", marginBottom: "1rem" }}>{`PROMPT 6 â Weakness Reframe
...
Keep it under 90 seconds when spoken.`}</pre>
          <pre style={{ background: "rgba(0,0,0,0.4)", border: "1px solid #374151", borderRadius: "8px", padding: "1.25rem", overflowX: "auto", fontSize: "0.9rem", color: "#a5f3fc", marginBottom: "1rem" }}>{`PROMPT 7 â Failure Story Polish
...
Avoid sounding defensive or like I am blaming others.`}</pre>
          <h2 style={{ fontSize: "1.5rem", color: "#fff", marginTop: "2rem", marginBottom: "1rem", borderBottom: "1px solid #374151", paddingBottom: "0.5rem" }}>Phase 3: Mock Interview Practice (Prompts 8â10)</h2>
          ...
          <pre style={{ background: "rgba(0,0,0,0.4)", border: "1px solid #374151", borderRadius: "8px", padding: "1.25rem", overflowX: "auto", fontSize: "0.9rem", color: "#a5f3fc", marginBottom: "1rem" }}>{`PROMPT 8 â First Round Mock Interview
...
Start with the first question.`}</pre>
          <pre style={{ background: "rgba(0,0,0,0.4)", border: "1px solid #374151", borderRadius: "8px", padding: "1.25rem", overflowX: "auto", fontSize: "0.9rem", color: "#a5f3fc", marginBottom: "1rem" }}>{`PROMPT 9 â Technical Deep Dive
...
and ask one realistic follow-up question before moving on.`}</pre>
          <pre style={{ background: "rgba(0,0,0,0.4)", border: "1px solid #374151", borderRadius: "8px", padding: "1.25rem", overflowX: "auto", fontSize: "0.9rem", color: "#a5f3fc", marginBottom: "1rem" }}>{`PROMPT 10 â Full Debrief
...
memorize as my closing statement in the final interview.`}</pre>
          <h2 style={{ fontSize: "1.5rem", color: "#fff", marginTop: "2rem", marginBottom: "1rem", borderBottom: "1px solid #374151", paddingBottom: "0.5rem" }}>Phase 4: Logistics and Follow-Up (Prompts 11â13)</h2>
          <p>The details around the interview â what to ask, how to follow up â often differentiate a forgettable candidate from one who gets an offer. AI makes it easy to craft highly personalized follow-up messages that reference specific things you discussed.</p>
          <pre style={{ background: "rgba(0,0,0,0.4)", border: "1px solid #374151", borderRadius: "8px", padding: "1.25rem", overflowX: "auto", fontSize: "0.9rem", color: "#a5f3fc", marginBottom: "1rem" }}>{`PROMPT 11 â Smart Questions Generator
...
Make them highly specific â avoid generic questions.`}</pre>
          <pre style={{ background: "rgba(0,0,0,0.4)", border: "1px solid #374151", borderRadius: "8px", padding: "1.25rem", overflowX: "auto", fontSize: "0.9rem", color: "#a5f3fc", marginBottom: "1rem" }}>{`PROMPT 12 â Thank You Note
...
Keep it under 200 words and professional but warm.`}</pre>
          <pre style={{ background: "rgba(0,0,0,0.4)", border: "1px solid #374151", borderRadius: "8px", padding: "1.25rem", overflowX: "auto", fontSize: "0.9rem", color: "#a5f3fc", marginBottom: "1rem" }}>{`PROMPT 13 â Follow-Up After Silence
...
Under 100 words.`}</pre>
          <h2 style={{ fontSize: "1.5rem", color: "#fff", marginTop: "2rem", marginBottom: "1rem", borderBottom: "1px solid #374151", paddingBottom: "0.5rem" }}>Phase 5: Offer Negotiation (Prompts 14â15)</h2>
          ...
          <pre style={{ background: "rgba(0,0,0,0.4)", border: "1px solid #374151", borderRadius: "8px", padding: "1.25rem", overflowX: "auto", fontSize: "0.9rem", color: "#a5f3fc", marginBottom: "1rem" }}>{`PROMPT 14 â Salary Counter Script
...
specific rationale, and leave room for dialogue without ultimatums.`}</pre>
          <pre style={{ background: "rgba(0,0,0,0.4)", border: "1px solid #374151", borderRadius: "8px", padding: "1.25rem", overflowX: "auto", fontSize: "0.9rem", color: "#a5f3fc", marginBottom: "1rem" }}>{`PROMPT 15 â Multi-Offer Comparison Framework
...
negotiate further before deciding.`}</pre>
          ...
          <div style={{ background: "rgba(0, 212, 255, 0.05)", border: "1px solid rgba(0, 212, 255, 0.2)", borderRadius: "12px", padding: "1.25rem", marginTop: "2rem", marginBottom: "2rem" }}>
            <p style={{ margin: 0, color: "#a5f3fc" }}>ð¡ <strong>Want more AI tools to accelerate your job search?</strong> <a href="/tools" style={{ color: "#00d4ff" }}>Browse the full toolkit â</a></p>
          </div>
        </div>
        <NewsletterCapture />
      </div>
