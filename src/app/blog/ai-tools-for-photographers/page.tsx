  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0f0f23 0%, #1a1a3e 50%, #0d1b2a 100%)", color: "#fff", fontFamily: "system-ui, sans-serif", padding: "2rem" }}>      <script
        ...
        dangerouslySetInnerHTML={{
          __html: `{"@context":"https://schema.org","@type":"Article","headline":"The Best AI Tools for Photographers in 2026: Culling, Editing, and Client Delivery","description":"A practical AI toolkit for photographers — faster culling, editing assistance, caption and client-communication tools, SEO, and automated delivery workflows.","image":"https://everydayaiworkflows.com/images/ai-tools-for-photographers.jpg","author":{"@type":"Organization","name":"Everyday AI Workflows"},"publisher":{"@type":"Organization","name":"Everyday AI Workflows","logo":{"@type":"ImageObject","url":"https://everydayaiworkflows.com/logo.png"}},"datePublished":"2026-07-16","dateModified":"2026-07-16","mainEntityOfPage":{"@type":"WebPage","@id":"https://everydayaiworkflows.com/blog/ai-tools-for-photographers"},"url":"https://everydayaiworkflows.com/blog/ai-tools-for-photographers"}}`
        }}
      />
