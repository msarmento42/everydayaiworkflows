...
{ slug: 'ai-email-triage-system', title: 'Build an AI Email Triage System: Turn Inbox Noise into a Review Queue', excerpt: 'Use explicit priority rules, draft safeguards, and a human review point to make email triage more consistent.', date: '2026-05-08', category: 'Automation', readingTime: '8 min' },
...
{ slug: 'ai-meeting-summarizer-workflow', title: 'Build an AI Meeting Summarizer Workflow: Turn Transcripts into Decisions', excerpt: 'Turn raw meeting transcripts into structured summaries, decision logs, and action items with a reviewable automation workflow.', date: '2026-06-17', category: 'Automation', readingTime: '6 min' },
...
{ slug: 'ai-for-customer-support', title: 'How to Use AI for Customer Support: A Practical, Reviewable Workflow', excerpt: 'Build a human-reviewed triage, drafting, escalation, and trend-analysis workflow for support tickets.', date: '2026-06-21', category: 'AI Tools', readingTime: '8 min' },
...
{ slug: 'ai-for-competitor-analysis', title: 'AI for Competitor Analysis: A Practical Workflow for a Decision-Ready Brief', excerpt: 'Use current source material to map positioning, pricing, reviews, and content strategy with explicit verification points.', date: '2026-07-08', category: 'AI Tools', readingTime: '9 min' },
...
export async function generateMetadata({ searchParams }: BlogPageProps) {
  ...
  const isIndexable = currentPage === 1;

  return {
    title: currentPage > 1 ? `AI Workflows Blog – Page ${currentPage}` : 'AI Workflows Blog',
    description: 'Evidence-led AI workflow guides, tool comparisons, and prompts with sources, limitations, and a human review point.',
    alternates: {
