...
const allPosts = [
  ...
  { slug: 'boost-productivity-with-ai', title: '5 Proven Ways to Boost Productivity with AI (With Real Workflows)', excerpt: 'Five specific AI patterns used by high-performers to reclaim 2-3 hours a day — from morning briefings to automating the connective tissue between tools.', date: '2026-05-21', category: 'Productivity', readingTime: '8 min' },
...
{ slug: 'ai-for-customer-support', title: 'How to Use AI for Customer Support: A Practical Workflow That Actually Scales', excerpt: 'Stop drowning in support tickets. Build an AI triage, draft, and escalation system that cuts manual load by 40-60% — no coding required.', date: '2026-05-22', category: 'AI Tools', readingTime: '8 min' },
  ...
  { slug: 'ai-tools-for-podcasters', title: 'AI Tools for Podcasters: From Episode Idea to Published Show in Half the Time', excerpt: 'How to use AI for guest research, show notes, episode scripting, content repurposing, and calendar planning — a full production workflow with copy-paste prompts.', date: '2026-05-24', category: 'Productivity', readingTime: '8 min' },
