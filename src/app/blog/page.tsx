...
{ slug: 'ai-tools-for-teachers', title: 'AI Tools for Teachers: Save 5 Hours a Week on Lesson Planning and Grading', excerpt: 'A practical guide for educators using AI to create lesson plans, differentiate instruction, write rubrics, give feedback faster, and handle the administrative load that eats teaching time.', date: '2026-06-14', category: 'Productivity', readingTime: '9 min' },
  ...
  { slug: 'chatgpt-vs-gemini-2026', title: 'ChatGPT vs. Gemini 2026: Which AI Model Should You Actually Use?', excerpt: 'A practical, task-by-task comparison of ChatGPT and Google Gemini -- writing, research, coding, image analysis, and pricing -- with a clear recommendation for each use case.', date: '2026-07-17', category: 'AI Tools', readingTime: '10 min' },
  ...
  { slug: 'perplexity-ai-vs-chatgpt', title: 'Perplexity AI vs. ChatGPT: Which One Should You Use for Research?', excerpt: 'A practical comparison of Perplexity and ChatGPT for research, citations, everyday Q&A, and writing -- with a clear recommendation for when to reach for each.', date: '2026-07-19', category: 'AI Tools', readingTime: '9 min' },
];
