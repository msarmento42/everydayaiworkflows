...
export const metadata = {
  ...
  description: "A practical AI-assisted workflow for nonfiction authors â outline structure, chapter drafting, research synthesis, and editing passes that cut writing time in half without losing your voice.",
};
    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0f0f23 0%, #1a1a3e 50%, #0d1b2a 100%)", color: "#fff", fontFamily: "system-ui, sans-serif", padding: "2rem" }}>
      <div style={{ maxWidth: "800px", margin: "0 auto", paddingTop: "2rem" }}>
        ...
        <div style={{ lineHeight: "1.8", fontSize: "1.05rem", color: "#d1d5db" }}>
          <p>Writing a nonfiction book is one of the most demanding creative and intellectual projects a person can take on. Most authors spend months just getting a coherent structure in place before they write a single publishable word. AI does not write the book for you â your expertise, your stories, and your voice are irreplaceable â but it can dramatically compress the structural, research, and editing phases that eat most of your writing time.</p>
...
4. Flag any assumptions I am making that readers might push back on`}</pre>
          <p>Run this prompt once, then iterate. The process of choosing between three different premises often reveals what you actually believe and care about most â which is exactly the kind of clarity that makes a book coherent from introduction to conclusion.</p>
...
I will pick the structure that feels most true to the material.`}</pre>
          ...
          <p>Nonfiction authors typically spend enormous amounts of time reading sources, taking notes, and then trying to synthesize them into coherent arguments. AI can compress the synthesis step dramatically â not by replacing your reading, but by helping you find the thread through what you have already read.</p>
...
3. Spot gaps â what evidence am I missing to make this argument airtight?
4. Write a 200-word synthesis paragraph I can use as a starting point`}</pre>
          ...
          <p>The biggest fear authors have about AI assistance is that their writing will start to sound generic. The solution is simple: never ask AI to write for you from scratch. Write your own rough draft â however messy â and use AI to help you develop, expand, and refine it.</p>
...
[paste your rough writing â can be notes, fragments, or messy paragraphs]
