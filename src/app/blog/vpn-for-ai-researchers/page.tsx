...
export const metadata = {
  ...
  description: "Why AI researchers, remote workers, and power users need a VPN — and how to pick one that keeps your prompts, API keys, and research data private.",
};
