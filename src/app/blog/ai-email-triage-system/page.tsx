    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0f0f23 0%, #1a1a3e 50%, #0d1b2a 100%)", color: "#fff", fontFamily: "system-ui, sans-serif", padding: "2rem" }}>
      <div style={{ maxWidth: "800px", margin: "0 auto", paddingTop: "2rem" }}>
        ...
        <div style={{ marginTop: "1rem", display: "flex", gap: "0.75rem", flexWrap: "wrap" }}>
          ...
          <span style={{ fontSize: "0.75rem", color: "#6b7280" }}>â±ï¸ 8 min read</span>
        ...
        <div style={{ lineHeight: "1.8", fontSize: "1.05rem", color: "#d1d5db" }}>
          ...
          <p>Before you write a single prompt, spend five minutes writing down your actual triage rules. Something like: emails from my boss, direct reports, or paying clients are High. Emails that need a decision from me are Medium. Everything else is Low â newsletters, FYIs, CC chains. Once you have this, you can give it to Claude as a system prompt and it will apply it to every batch you feed it.</p>
...
Output as a table: # | Priority | Action | Draft Reply (1 sentence)`}</pre>
          ...
          <p>For High-priority emails, you want full drafts, not just a sentence. Paste the actual email thread and ask for a complete reply. Tell Claude your goal and constraints â word count, what not to commit to, the relationship context.</p>
...
[Paste email thread here]`}</pre>
          ...
          <p>Manual batch prompting works, but full automation is where this system really pays off. With <a href="https://www.make.com/en/register?pc=msarmento42" rel="noopener sponsored" style={{ color: "#00d4ff" }}>Make.com</a>, you can build a workflow that automatically pulls new emails from Gmail or Outlook, sends them through a Claude analysis step, and routes them into labeled folders â all without you touching anything.</p>
          <p>A basic Make.com automation for email triage: Gmail trigger â filter newsletters by sender domain â Claude API call with your triage prompt â parse priority label â apply Gmail label and draft reply. This runs constantly, so when you open your inbox each morning, everything is already sorted.</p>
...
next week.`}</pre>
          ...
          <div style={{ background: "rgba(0, 212, 255, 0.05)", border: "1px solid rgba(0, 212, 255, 0.2)", borderRadius: "12px", padding: "1.25rem", marginTop: "2rem", marginBottom: "2rem" }}>
            <p style={{ margin: 0, color: "#a5f3fc" }}>ð¡ <strong>Ready to automate your full communication stack?</strong> <a href="/tools" style={{ color: "#00d4ff" }}>Browse the full toolkit â</a></p>
          </div>
        </div>
        <NewsletterCapture />
      </div>
