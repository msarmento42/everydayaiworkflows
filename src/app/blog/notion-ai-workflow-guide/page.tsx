...
[paste list]`}</pre>
  ...
  <a href="https://notion.so" target="_blank" rel="noopener noreferrer" style={{ display: "inline-block", background: "#00d4ff", color: "#0f0f23", padding: "0.75rem 1.5rem", borderRadius: "4px", textDecoration: "none", fontWeight: "bold" }}>Start Using Notion AI</a>
