    ...
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0f0f23 0%, #1a1a3e 50%, #0d1b2a 100%)", color: "#fff", fontFamily: "system-ui, sans-serif", padding: "2rem" }}>
      <div style={{ maxWidth: "800px", margin: "0 auto", paddingTop: "2rem" }}>
        ...
        <div style={{ lineHeight: "1.8", fontSize: "1.05rem", color: "#d1d5db" }}>
          ...
          <p><a href="https://affiliate.notion.so/everydayaiworkflows" rel="noopener sponsored" style={{ color: "#00d4ff" }}>Notion AI</a> can help organize client call summaries, deliverables, and recurring context in one workspace. Supply only notes you are authorized to store, then ask for action items, a client-ready draft, or a task list for review.</p>
